...
+
https://automationstore.netapp.com/home.shtml["NetApp存储自动化商店"^]
...
+
有关Windows cmdlet的详细信息，请参阅 https://docs.netapp.com/us-en/snapcenter-cmdlets-50/index.htmllllll["《 SnapCenter 软件 cmdlet 参考指南》"^]。
...
* SnapCenter 自定义插件
+
自定义插件受社区支持，可从下载 https://automationstore.netapp.com/home.shtml["NetApp存储自动化商店"^]。
...
适用于SnapCenter软件的MySQL、DB2和MongoDB自定义插件示例可从下载 https://automationstore.netapp.com/home.shtml["NetApp存储自动化商店"^]。
