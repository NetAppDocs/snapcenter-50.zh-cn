...
* ONTAP for Windows和Linux主机上的SnapCenter支持IPSec。 https://docs.netapp.com/us-en/ontap/networking/configure_ip_security_@ipsec@_over_wire_encryption.html#use-ipsec-identities["了解更多信息。"](英文)
...
* 支持在SnapCenter服务器和ONTAP之间进行CA证书身份验证。 https://kb.netapp.com/Advice_and_Troubleshooting/Data_Protection_and_Security/SnapCenter/How_to_securely_connect_SnapCenter_with_ONTAP_using_CA_certificate["了解更多信息。"](英文)
