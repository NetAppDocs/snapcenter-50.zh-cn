...
NetApp®Single Mailbox Recovery已于2023年5月12日终止提供(EOA)。有关详细信息，请参阅 link:https://mysupport.netapp.com/info/communications/ECMLP2885729.html["CPC-00507"]。在支持授权期间、NetApp将继续通过2020年6月24日推出的营销部件号为已购买邮箱容量、维护和支持的客户提供支持。
