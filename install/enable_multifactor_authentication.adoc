...
* 有关可与cmdlet结合使用的参数及其说明的信息，可通过运行来获取 `Get-Help command_name`。或者，您也可以参见 https://docs.netapp.com/us-en/snapcenter-cmdlets-50/index.html["《 SnapCenter 软件 cmdlet 参考指南》"^]。
