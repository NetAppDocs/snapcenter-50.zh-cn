...
NOTE: 对于SAP HANA系统复制、生成的Snapshot总数将等于为资源组设置的保留时间。删除最旧Snapshot取决于最旧Snapshot所在的节点。例如，对于使用 SAP HANA System Replication primary 和 SAP HANA System Replication secondary 的资源组，保留设置为 7 。一次最多可以创建7个快照、包括SAP HANA系统复制主系统和SAP HANA系统复制二级系统。
