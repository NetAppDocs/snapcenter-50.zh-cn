...
.. 在为选定策略配置计划部分中、单击要配置计划的策略的配置计划列中的*image:../media/add_policy_from_resourcegroup.gif[""]。
...
.. 单击 * 确定 * 。
+
已配置的计划将列在 "applied Schedules" 列中。您可以单击**查看并编辑、也可以image:../media/edit_icon.gif["用于编辑已配置计划的图标"]单击**删除image:../media/delete_icon_for_configuringschedule.gif["删除图标"]。
