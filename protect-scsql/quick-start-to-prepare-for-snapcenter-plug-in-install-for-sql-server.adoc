...
如果您使用的是SnapManager for Microsoft SQL Server、并希望将数据从SnapManager for Microsoft SQL Server导入到SnapCenter中、请参阅 link:../protect-scsql/concept_import_archived_backups_from_snapmanager_for_sql_to_snapcenter.html["导入归档备份"^]
