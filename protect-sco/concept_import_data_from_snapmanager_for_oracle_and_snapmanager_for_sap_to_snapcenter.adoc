...
中列出了适用于Oracle数据库的SnapCenter插件支持的配置 https://imt.netapp.com/matrix/imt.jsp?components=117016;&solution=1259&isHWU&src=IMT["NetApp 互操作性表工具"^]。
...
|===
| SnapManager for Oracle 和 SnapManager for SAP 参数和值 | SnapCenter 参数和值 | 备注 
