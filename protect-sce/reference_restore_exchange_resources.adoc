...
您也可以手动或在脚本中使用 PowerShell cmdlet 执行备份和还原操作。有关PowerShell cmdlet的详细信息，请使用SnapCenter cmdlet帮助或参阅。 https://docs.netapp.com/us-en/snapcenter-cmdlets-50/index.htmll["《 SnapCenter 软件 cmdlet 参考指南》"^]
